...
public:
     ...
     */
    VX_EXPORT CKDirectoryParser(const char *dir, const char *fileMask, XBOOL recurse = FALSE);
     ...
     */
    VX_EXPORT const char *GetNextFile();
     ...
     */
    VX_EXPORT void Reset(const char *dir = NULL, const char *fileMask = NULL, XBOOL recurse = FALSE);
