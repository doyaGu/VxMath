...
public:
    ...
    ************************************************/
    ...
    friend VxPlane operator-(const VxPlane &p);
    ...
    ************************************************/
    ...
    See also: Classify
    ************************************************/
    VxVector NearestPoint(const VxVector &p) const { return p + m_Normal * -Classify(p); }
...
inline VxPlane operator-(const VxPlane &p)
{
