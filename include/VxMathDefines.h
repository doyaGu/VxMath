...
typedef enum InstructionSetExtensions
{
    ...
    ISEX_SSE       = 0x00000001,	// SSE
    ISEX_SSE2      = 0x00000002,	// SSE2
    ISEX_SSE3      = 0x00000004,	// SSE3
    ISEX_SSSE3     = 0x00000008,	// SSSE3
    ISEX_SSE41     = 0x00000010,	// SSE4.1
    ISEX_SSE42     = 0x00000020,	// SSE4.2
    ISEX_AVX       = 0x00000040,	// AVX
    ISEX_AVX2      = 0x00000080,	// AVX2
