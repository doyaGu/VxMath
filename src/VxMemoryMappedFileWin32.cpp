...
VxMemoryMappedFile::VxMemoryMappedFile(char *pszFileName) : m_hFile(INVALID_HANDLE_VALUE), m_hFileMapping(NULL), m_pMemoryMappedFileBase(NULL), m_cbFile(0), m_errCode(VxMMF_FileOpen)
{
